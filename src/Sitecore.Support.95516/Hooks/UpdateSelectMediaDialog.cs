...
{
    public class UpdateSelectMediaDialog : IHook
    {
        public void Initialize()
        {
            using (new SecurityDisabler())
            {
                ...
                var fieldValue = item[fieldName].Replace("PageCodeTypeName=Sitecore.Speak.Applications.SelectMediaDialog%2c+Sitecore.Speak.Applications", "PageCodeTypeName=Sitecore.Support.Speak.Applications.SelectMediaDialog%2c+Sitecore.Support.95516");
